...
export function InviteManager({ eventId, invitations, defaultOpen=false, readOnly=false }: { eventId:string; invitations:Invitation[]; defaultOpen?:boolean; readOnly?:boolean }) {
